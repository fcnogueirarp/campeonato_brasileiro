...
import { getApi2014 } from '../services/api/api';
import { getNewId } from '../services/uuid/uuid';

export default function Cb2014() {
  const [a2014, setA2014] = useState([]);

  let times = [];

  useEffect(() => {
    (async function getApi() {
      const api2014 = await getApi2014();
      setA2014(api2014[api2014.length - 1].partidas);
    })();
  }, []);
