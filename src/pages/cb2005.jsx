...
import { getApi2005 } from '../services/api/api';
import { getNewId } from '../services/uuid/uuid';

export default function Cb2005() {
  const [a2005, setA2005] = useState([]);

  let times = [];

  useEffect(() => {
    (async function getApi() {
      const api2005 = await getApi2005();
      setA2005(api2005[api2005.length - 1].partidas);
    })();
  }, []);
