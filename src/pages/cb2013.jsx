...
import { getApi2013 } from '../services/api/api';
import { getNewId } from '../services/uuid/uuid';

export default function Cb2013() {
  const [a2013, setA2013] = useState([]);

  let times = [];

  useEffect(() => {
    (async function getApi() {
      const api2013 = await getApi2013();
      setA2013(api2013[api2013.length - 1].partidas);
    })();
  }, []);
