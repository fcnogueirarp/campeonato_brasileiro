...
import { getApi2009 } from '../services/api/api';
import { getNewId } from '../services/uuid/uuid';

export default function Cb2009() {
  const [a2009, setA2009] = useState([]);

  let times = [];

  useEffect(() => {
    (async function getApi() {
      const api2009 = await getApi2009();
      setA2009(api2009[api2009.length - 1].partidas);
    })();
  }, []);
