...
import { getApi2007 } from '../services/api/api';
import { getNewId } from '../services/uuid/uuid';

export default function Cb2007() {
  const [a2007, setA2007] = useState([]);

  let times = [];

  useEffect(() => {
    (async function getApi() {
      const api2007 = await getApi2007();
      setA2007(api2007[api2007.length - 1].partidas);
    })();
  }, []);
