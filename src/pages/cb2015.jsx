...
import { getApi2015 } from '../services/api/api';
import { getNewId } from '../services/uuid/uuid';

export default function Cb2015() {
  const [a2015, setA2015] = useState([]);

  let times = [];

  useEffect(() => {
    (async function getApi() {
      const api2015 = await getApi2015();
      setA2015(api2015[api2015.length - 1].partidas);
    })();
  }, []);
