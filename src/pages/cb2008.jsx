...
import { getApi2008 } from '../services/api/api';
import { getNewId } from '../services/uuid/uuid';

export default function Cb2008() {
  const [a2008, setA2008] = useState([]);

  let times = [];

  useEffect(() => {
    (async function getApi() {
      const api2008 = await getApi2008();
      setA2008(api2008[api2008.length - 1].partidas);
    })();
  }, []);
