...
import { getApi2006 } from '../services/api/api';
import { getNewId } from '../services/uuid/uuid';

export default function Cb2006() {
  const [a2006, setA2006] = useState([]);

  let times = [];

  useEffect(() => {
    (async function getApi() {
      const api2006 = await getApi2006();
      setA2006(api2006[api2006.length - 1].partidas);
    })();
  }, []);
