...
import { getApi2012 } from '../services/api/api';
import { getNewId } from '../services/uuid/uuid';

export default function Cb2012() {
  const [a2012, setA2012] = useState([]);

  let times = [];

  useEffect(() => {
    (async function getApi() {
      const api2012 = await getApi2012();
      setA2012(api2012[api2012.length - 1].partidas);
    })();
  }, []);
