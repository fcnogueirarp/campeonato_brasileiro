...
import { getApi2011 } from '../services/api/api';
import { getNewId } from '../services/uuid/uuid';

export default function Cb2011() {
  const [a2011, setA2011] = useState([]);

  let times = [];

  useEffect(() => {
    (async function getApi() {
      const api2011 = await getApi2011();
      setA2011(api2011[api2011.length - 1].partidas);
    })();
  }, []);
